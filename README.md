...
### Поля `plants.json` для сайту
- `verb` — дієслово заголовка сторінки культури: `садити` · `сіяти` · `висаджувати` · `пересаджувати` («Коли сіяти моркву під зиму 2026»).
- `synonyms` — 0–3 інші назви, під якими культуру шукають (томати → помідори, баклажан → синенькі); не повторюють `name_ua` і `name_acc`.
- `moon_tips` — порада за фазою. Якщо в ній названо знак, у якому культура справді має дні, мають бути названі **всі** такі знаки (інакше порада суперечить списку днів). Це, а також `verb` і `synonyms`, перевіряє `check.mjs`.
